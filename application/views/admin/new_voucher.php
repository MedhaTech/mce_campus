                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input type="text" readonly name="renewal_of_registration_fees" id="renewal_of_registration_fees" class="form-control" value="<?php echo (set_value('renewal_of_registration_fees')) ? set_value('renewal_of_registration_fees') : $fee_structure->renewal_of_registration_fees; ?>">
                                ...
                                <div class="col-md-1">
                                    ...
                                    ?>
                                    <input type="checkbox" <?= $readonly; ?> name="fees[]" id="renewal_of_registration_fees_checkbox" value="<?php echo (set_value('renewal_of_registration_fees')) ? set_value('renewal_of_registration_fees') : $fee_structure->renewal_of_registration_fees; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input type="text" readonly name="e_consortium_fees" id="e_consortium_fees" class="form-control" value="<?php echo (set_value('e_consortium_fees')) ? set_value('e_consortium_fees') : $fee_structure->e_consortium_fees; ?>">
                                    <span class="text-danger"></span>
                                </div>
                                <div class="col-md-1">
                                    ...
                                    ?>
                                    <input type="checkbox" <?= $readonly; ?> name="fees[]" id="e_consortium_fees_checkbox" value="<?php echo (set_value('e_consortium_fees')) ? set_value('e_consortium_fees') : $fee_structure->e_consortium_fees; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input type="text" readonly name="students_sports_fees" id="students_sports_fees" class="form-control" value="<?php echo (set_value('students_sports_fees')) ? set_value('students_sports_fees') : $fee_structure->students_sports_fees; ?>">
                                    <span class="text-danger"></span>
                                </div>
                                <div class="col-md-1">
                                    ...
                                    ?>
                                    <input type="checkbox" <?= $readonly; ?> name="fees[]" id="students_sports_fees_checkbox" value="<?php echo (set_value('students_sports_fees')) ? set_value('students_sports_fees') : $fee_structure->students_sports_fees; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input type="text" readonly name="students_sports_development_fees" id="students_sports_development_fees" class="form-control" value="<?php echo (set_value('students_sports_development_fees')) ? set_value('students_sports_development_fees') : $fee_structure->students_sports_development_fees; ?>">
                                    <span class="text-danger"></span>
                                </div>
                                <div class="col-md-1">
                                    ...
                                    ?>
                                    <input type="checkbox" <?= $readonly; ?> name="fees[]" id="students_sports_development_fees_checkbox" value="<?php echo (set_value('students_sports_development_fees')) ? set_value('students_sports_development_fees') : $fee_structure->students_sports_development_fees; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input type="text" readonly name="career_guideliness_and_counselling_fees" id="career_guideliness_and_counselling_fees" class="form-control" value="<?php echo (set_value('career_guideliness_and_counselling_fees')) ? set_value('career_guideliness_and_counselling_fees') : $fee_structure->career_guideliness_and_counselling_fees; ?>">
                                    <span class="text-danger"></span>
                                </div>
                                <div class="col-md-1">
                                    ...
                                    ?>
                                    <input type="checkbox" <?= $readonly; ?> name="fees[]" id="career_guideliness_and_counselling_fees_checkbox" value="<?php echo (set_value('career_guideliness_and_counselling_fees')) ? set_value('career_guideliness_and_counselling_fees') : $fee_structure->career_guideliness_and_counselling_fees; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input type="text" readonly name="university_development_fees" id="university_development_fees" class="form-control" value="<?php echo (set_value('university_development_fees')) ? set_value('university_development_fees') : $fee_structure->university_development_fees; ?>">
                                    <span class="text-danger"></span>
                                </div>
                                <div class="col-md-1">
                                    ...
                                    ?>
                                    <input type="checkbox" <?= $readonly; ?> name="fees[]" id="university_development_fees_checkbox" value="<?php echo (set_value('university_development_fees')) ? set_value('university_development_fees') : $fee_structure->university_development_fees; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input type="text" readonly name="cultural_activities_fees" id="cultural_activities_fees" class="form-control" value="<?php echo (set_value('cultural_activities_fees')) ? set_value('cultural_activities_fees') : $fee_structure->cultural_activities_fees; ?>">
                                    <span class="text-danger"></span>
                                </div>
                                <div class="col-md-1">
                                    ...
                                    ?>
                                    <input type="checkbox" <?= $readonly; ?> name="fees[]" id="cultural_activities_fees_checkbox" value="<?php echo (set_value('cultural_activities_fees')) ? set_value('cultural_activities_fees') : $fee_structure->cultural_activities_fees; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input type="text" readonly name="teachers_development_fees" id="teachers_development_fees" class="form-control" value="<?php echo (set_value('teachers_development_fees')) ? set_value('teachers_development_fees') : $fee_structure->teachers_development_fees; ?>">
                                    <span class="text-danger"></span>
                                </div>
                                <div class="col-md-1">
                                    ...
                                    ?>
                                    <input type="checkbox" <?= $readonly; ?> name="fees[]" id="teachers_development_fees_checkbox" value="<?php echo (set_value('teachers_development_fees')) ? set_value('teachers_development_fees') : $fee_structure->teachers_development_fees; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input type="text" readonly name="student_development_fees" id="student_development_fees" class="form-control" value="<?php echo (set_value('student_development_fees')) ? set_value('student_development_fees') : $fee_structure->student_development_fees; ?>">
                                    <span class="text-danger"></span>
                                </div>
                                <div class="col-md-1">
                                    ...
                                    ?>
                                    <input type="checkbox" <?= $readonly; ?> name="fees[]" id="student_development_fees_checkbox" value="<?php echo (set_value('student_development_fees')) ? set_value('student_development_fees') : $fee_structure->student_development_fees; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input type="text" readonly name="indian_red_cross_membership_fees" id="indian_red_cross_membership_fees" class="form-control" value="<?php echo (set_value('indian_red_cross_membership_fees')) ? set_value('indian_red_cross_membership_fees') : $fee_structure->indian_red_cross_membership_fees; ?>">
                                    <span class="text-danger"></span>
                                </div>
                                <div class="col-md-1">
                                    ...
                                    ?>
                                    <input type="checkbox" <?= $readonly; ?> name="fees[]" id="indian_red_cross_membership_fees_checkbox" value="<?php echo (set_value('indian_red_cross_membership_fees')) ? set_value('indian_red_cross_membership_fees') : $fee_structure->indian_red_cross_membership_fees; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input type="text" readonly name="women_cell_fees" id="women_cell_fees" class="form-control" value="<?php echo (set_value('women_cell_fees')) ? set_value('women_cell_fees') : $fee_structure->women_cell_fees; ?>">
                                    <span class="text-danger"></span>
                                </div>
                                <div class="col-md-1">
                                    ...
                                    ?>
                                    <input type="checkbox" <?= $readonly; ?> name="fees[]" id="women_cell_fees_checkbox" value="<?php echo (set_value('women_cell_fees')) ? set_value('women_cell_fees') : $fee_structure->women_cell_fees; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input type="text" readonly name="nss_fees" id="nss_fees" class="form-control" value="<?php echo (set_value('nss_fees')) ? set_value('nss_fees') : $fee_structure->nss_fees; ?>">
                                    <span class="text-danger"></span>
                                </div>
                                <div class="col-md-1">
                                    ...
                                    ?>
                                    <input type="checkbox" <?= $readonly; ?> name="fees[]" id="nss_fees_checkbox" value="<?php echo (set_value('nss_fees')) ? set_value('nss_fees') : $fee_structure->nss_fees; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input type="text" readonly name="teachers_flag_fees" id="teachers_flag_fees" class="form-control" value="<?php echo (set_value('teachers_flag_fees')) ? set_value('teachers_flag_fees') : $fee_structure->teachers_flag_fees; ?>">
                                    <span class="text-danger"></span>
                                </div>
                                <div class="col-md-1">
                                    ...
                                    ?>
                                    <input type="checkbox" <?= $readonly; ?> name="fees[]" id="teachers_flag_fees_checkbox" value="<?php echo (set_value('teachers_flag_fees')) ? set_value('teachers_flag_fees') : $fee_structure->teachers_flag_fees; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input type="text" readonly name="college_other_fees" id="college_other_fees" class="form-control" value="<?php echo (set_value('college_other_fees')) ? set_value('college_other_fees') : $fee_structure->college_other_fees; ?>">
                                    <span class="text-danger"></span>
                                </div>
                                <div class="col-md-1">
                                    ...
                                    ?>
                                    <input type="checkbox" <?= $readonly; ?> name="fees[]" id="college_other_fees_checkbox" value="<?php echo (set_value('college_other_fees')) ? set_value('college_other_fees') : $fee_structure->college_other_fees; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input type="text" readonly name="tuition_fee" id="tuition_fee" class="form-control" value="<?php echo (set_value('tuition_fee')) ? set_value('tuition_fee') : $fee_structure->tuition_fee; ?>">
                                    <span class="text-danger"></span>
                                </div>
                                <div class="col-md-1">
                                    ...
                                    ?>
                                    <input type="checkbox" <?= $readonly; ?> name="fees[]" id="tuition_fee_checkbox" value="<?php echo (set_value('tuition_fee')) ? set_value('tuition_fee') : $fee_structure->tuition_fee; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input type="text" readonly name="corpus_fee_demand" id="corpus_fee_demand" class="form-control" value="<?php echo (set_value('corpus_fee_demand')) ? set_value('corpus_fee_demand') : $fee_structure->corpus_fee_demand; ?>">
                                    <span class="text-danger"></span>
                                </div>
                                <div class="col-md-1">
                                    ...
                                    ?>
                                    <input type="checkbox" <?= $readonly; ?> name="fees[]" id="corpus_fee_demand_checkbox" value="<?php echo (set_value('corpus_fee_demand')) ? set_value('corpus_fee_demand') : $fee_structure->corpus_fee_demand; ?>">
                                </div>
                            </div>
                            <hr />
