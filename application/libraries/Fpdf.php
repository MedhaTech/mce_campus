...
public $tablewidths;        // more pages table widths 
public $footerset;
public $widths;                // MULTICELL TABLE widths
public $aligns;                // MULTICELL TABLE aligns
...
function Header()
{
    ...
    {
        $logo = "assets/img/bmsce.png";
        $this->Image($logo, 10, 5, 80, 0);

        $this->setFont ('Helvetica','B',18);     
        $this->SetXY(180, 8);  
        $this->SetTextColor(63, 81, 181);
        $this->Cell(100,10,'Faculty Feedback Report',0,0,'C', false);
    ...
    if ($this->enableheader == "plain")
    {
        $logo = base_url()."assets/img/bmsce.png";
        // $this->Image($logo, 10, 5, 80, 0, 'png');
...
function Footer()
{
	...
	if ($this->enablefooter == 1)
    {
      if(!isset($this->footerset[$this->page])) {             
         ...
         $this->Cell( 0, 10, 'campus@bmsce.ac.in | www.bmsce.ac.in', 0, 0, 'L' ); 
...
// END PIE CHART
    ...
    function feedbackTable($datas, $lineheight=8) {
